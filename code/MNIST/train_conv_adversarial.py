...
from model_defs import mnist_conv_big
    


class TrainConvMNIST:
    ...
    def training(self):
        ...
        print(f"Start training MNIST Conv Adversarial model under seed {self.seed}\n")
    ...
    def save_model(self):
        os.makedirs(os.path.join("models", "MNIST", "conv_adversarial"), exist_ok=True)
        torch.save(self.model.state_dict(), os.path.join("models", "MNIST", "conv_adversarial",
                                                         f"MNIST_conv_adversarial_{self.seed}.pth"))
    ...
    def train_loop(self, epoch):
        ...
        for _, (inputs, targets) in enumerate(self.train_loader):
            ...
            delta = self.fgsm_attack(inputs, targets)
...
if __name__ == "__main__":
    ...
    training = TrainConvMNIST(seed=args.seed)
    training.main()
