...
from model_defs import mnist_fc_3_512
...
class TrainFCMNIST:
    ...
    def training(self):
        ...
        print(f"Start training MNIST FC model under seed {self.seed}\n")
    ...
    def save_model(self):
        os.makedirs(os.path.join("models", "MNIST", "FC_adversarial"), exist_ok=True)
        torch.save(self.model.state_dict(), os.path.join("models", "MNIST", "FC_adversarial",
                                                         f"MNIST_FC_adversarial_{self.seed}.pth"))
...
if __name__ == "__main__":
    ...
    training = TrainFCMNIST(seed=args.seed)
    training.main()
