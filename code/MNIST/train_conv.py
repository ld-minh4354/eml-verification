...
class TrainConvMNIST:
    ...
    def training(self):
        ...
        print(f"Start training MNIST Conv model under seed {self.seed}\n")
    ...
    def save_model(self):
        os.makedirs(os.path.join("models", "MNIST", "conv"), exist_ok=True)
        torch.save(self.model.state_dict(), os.path.join("models", "MNIST", "conv",
                                                         f"MNIST_conv_{self.seed}.pth"))
